...
public class TopicController {
	...
	@RequestMapping("/topics/{serviceid}")
	public Topic getTopic(@PathVariable("serviceid") String id) {
		return topicService.getTopic(id);

	}

	/*
	 * or alternative just pass the same parameter value "id" so as to avoid
